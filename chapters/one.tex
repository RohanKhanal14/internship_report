...
\begin{itemize}
  \item To understand and implement DevOps practices using cloud technologies in a production-level environment.
\end{itemize}
...
\begin{itemize}
  ...
  Describes Genese Solution Pvt.\ Ltd., its services, working environment, and organizational structure and covers theoretical concepts related to DevOps.
